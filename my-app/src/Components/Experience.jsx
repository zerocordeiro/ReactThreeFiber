...
export const Experience = () => {
  return (
    <>
      ...
      <directionalLight intensity={.5} position={[6,2,3]} castShadow shadow-camera-left={-20} shadow-camera-right={20} shadow-camera-top={20} shadow-camera-bottom={-20} shadow-mapSize={(512,512)}
      />
